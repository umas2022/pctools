...
# 全局添加工具箱引用目录：py_script
import sys
server_dir = os.path.split(os.path.realpath(__file__))[0] # pctools/py_server
pctools_dir = os.path.split(os.path.split(server_dir)[0])[0] # pctools/
script_dir = os.path.join(pctools_dir,"py_script")
