    ...
    <div class="cp-path">
        <BasicTemplate>
            ...
            <template #tp-info>
                ...
                <span class="line">2.路径定位到py_server文件夹</span>
                <span class="line">3.默认通过static_path函数自动定位到打包后的public路径下</span>
                <span class="line">4.当前: {{ store_home.py_server }}</span>
            </template>
...
const pre_path = ref(JSON.parse(JSON.stringify(store_home.py_server)))

const reset_path = () => {
    store_home.py_server = pre_path
